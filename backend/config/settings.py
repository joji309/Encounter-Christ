...
MIDDLEWARE = [
    'config.middleware.AdminPathMiddleware',
...
STORAGES = {
    'default': {
        # Vercel's filesystem is read-only at runtime. Use Cloudinary for all
        # production admin uploads whenever its credentials are configured.
        'BACKEND': (
